...
function CardCrate2() {
  return (
    <div className='w-full h-fit bg-[#F6F9FC] pb-10'>
      <div className='max-w-[1048px] w-full mx-auto pt-24'>
        ...
        <p className='w-[60%] text-lg text-slate-500'>If you’d like to use Stripe for your business but don’t have developers on staff, no problem. We have a few options depending on your needs.
